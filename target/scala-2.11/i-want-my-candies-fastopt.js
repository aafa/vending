...
function $is_Ldiode_Action(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ldiode_Action)))
}
function $as_Ldiode_Action(obj) {
  return (($is_Ldiode_Action(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "diode.Action"))
}
function $isArrayOf_Ldiode_Action(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ldiode_Action)))
}
function $asArrayOf_Ldiode_Action(obj, depth) {
  return (($isArrayOf_Ldiode_Action(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ldiode.Action;", depth))
}
...
function $s_Ldiode_Circuit$class__diode$Circuit$$process__Ldiode_Circuit__O__Ldiode_ActionResult($$this, action) {
  var this$1 = $as_s_Option($$this.actionHandler__F2().apply__O__O__O($$this.model$1, action));
...
function $s_Ldiode_Circuit$class__$$init$__Ldiode_Circuit__V($$this) {
  $$this.model$1 = new $c_Lcom_github_aafa_vending_diode_RootModel().init___sc_Seq__Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin__T__s_Option($m_Lcom_github_aafa_vending_diode_RootModel$().apply$default$1__sc_Seq(), new $c_Lcom_github_aafa_vending_diode_CandyCoin().init___I(0), new $c_Lcom_github_aafa_vending_diode_CandyCoin().init___I(100), "What candy do you want?", $m_s_None$());
  ...
  $$this.diode$Circuit$$dispatchQueue$1 = ($m_sci_Queue$(), $m_sci_Queue$EmptyQueue$());
...
function $s_Ldiode_Circuit$class__buildProcessChain__p0__Ldiode_Circuit__F1($$this) {
  ...
  var op = new $c_Ldiode_Circuit$$anonfun$buildProcessChain$2().init___Ldiode_Circuit($$this);
  return $as_F1($s_sc_LinearSeqOptimized$class__foldLeft__sc_LinearSeqOptimized__O__F2__O(this$1, z, op))
}
function $s_Ldiode_Circuit$class__dispatchBase__Ldiode_Circuit__O__Z($$this, action) {
  try {
    ...
    if ((!(x === x1))) {
      if ($is_Ldiode_ActionResult$ModelUpdate(x1)) {
        ...
        var this$1 = effects.run__F1__s_concurrent_Future(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
          return (function(a$2) {
            var evidence$6 = $m_Ldiode_package$AnyAction$aType$();
            $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V(arg$outer, a$2, evidence$6)
          })
        })($$this)));
        var pf = new $c_Ldiode_Circuit$$anonfun$dispatchBase$1().init___Ldiode_Circuit__O($$this, action);
        var executor = effects.ec$1;
        $s_s_concurrent_Future$class__recover__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__s_concurrent_Future(this$1, pf, executor);
        return true
        ...
        var this$2 = effects$2.run__F1__s_concurrent_Future(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer$1) {
          return (function(a$2$1) {
            var evidence$6$1 = $m_Ldiode_package$AnyAction$aType$();
            $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V(arg$outer$1, a$2$1, evidence$6$1)
          })
        })($$this)));
        var pf$1 = new $c_Ldiode_Circuit$$anonfun$dispatchBase$2().init___Ldiode_Circuit__O($$this, action);
        var executor$1 = effects$2.ec$1;
        $s_s_concurrent_Future$class__recover__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__s_concurrent_Future(this$2, pf$1, executor$1);
        return false
        ...
        $s_Ldiode_Circuit$class__update__p0__Ldiode_Circuit__O__V($$this, newModel$4);
        var this$3 = effects$3.run__F1__s_concurrent_Future(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer$2) {
          return (function(a$2$2) {
            var evidence$6$2 = $m_Ldiode_package$AnyAction$aType$();
            $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V(arg$outer$2, a$2$2, evidence$6$2)
          })
        })($$this)));
        var pf$2 = new $c_Ldiode_Circuit$$anonfun$dispatchBase$3().init___Ldiode_Circuit__O($$this, action);
        var executor$2 = effects$3.ec$1;
        $s_s_concurrent_Future$class__recover__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__s_concurrent_Future(this$3, pf$2, executor$2);
        return true
      } else {
...
function $s_Ldiode_Circuit$class__handleError__Ldiode_Circuit__T__V($$this, msg) {
...
function $s_Ldiode_Circuit$class__subscribe__Ldiode_Circuit__Ldiode_ModelR__F1__F0($$this, cursor, listener) {
  ...
  var y = $$this.diode$Circuit$$Subscription__Ldiode_Circuit$Subscription$().apply__F1__Ldiode_ModelR__O__Ldiode_Circuit$Subscription(listener, cursor, cursor.eval__O__O($$this.model$1));
...
function $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V($$this, action, evidence$6) {
  if (($$this === null)) {
    throw new $c_jl_NullPointerException().init___()
  };
  if ((!$$this.diode$Circuit$$isDispatching$1)) {
    $s_Ldiode_Circuit$class__liftedTree1$1__p0__Ldiode_Circuit__O__V($$this, action);
    var this$1 = $$this.diode$Circuit$$dispatchQueue$1.dequeueOption__s_Option();
    if ((!this$1.isEmpty__Z())) {
      ...
      if ((x0$4 !== null)) {
        ...
        $$this.diode$Circuit$$dispatchQueue$1 = queue;
        $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V($$this, nextAction, null)
      } else {
        throw new $c_s_MatchError().init___O(x0$4)
      }
    }
  } else {
    $$this.diode$Circuit$$dispatchQueue$1 = $$this.diode$Circuit$$dispatchQueue$1.enqueue__O__sci_Queue(action)
  }
}
function $s_Ldiode_Circuit$class__liftedTree1$1__p0__Ldiode_Circuit__O__V($$this, action$4) {
  try {
    $$this.diode$Circuit$$isDispatching$1 = true;
    var oldModel = $$this.model$1;
    var silent = $s_Ldiode_Circuit$class__dispatchBase__Ldiode_Circuit__O__Z($$this, action$4);
    if ((oldModel !== $$this.model$1)) {
      var this$2 = $$this.diode$Circuit$$listeners$1;
      var z = $$this.diode$Circuit$$listeners$1;
      var op = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(arg$outer, silent$1) {
        return (function(x0$2$2, x1$2$2) {
          ...
          if ((p2 !== null)) {
            ...
            var this$1 = arg$outer.diode$Circuit$$listeners$1;
            if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(this$1, key)) {
      ...
      var updated = $as_sci_Map($s_sc_TraversableOnce$class__foldLeft__sc_TraversableOnce__O__F2__O(this$2, z, op));
      var z$1 = $$this.diode$Circuit$$listeners$1;
      var op$1 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(x0$3$2, x1$3$2) {
        ...
        if ((p2$1 !== null)) {
          ...
          return ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(l$1, key$1) ? l$1.updated__O__O__sci_Map(key$1, sub$1) : l$1)
        };
        throw new $c_s_MatchError().init___O(x1$1)
      }));
      $$this.diode$Circuit$$listeners$1 = $as_sci_Map($s_sc_TraversableOnce$class__foldLeft__sc_TraversableOnce__O__F2__O(updated, z$1, op$1))
    }
  } catch (e) {
    var e$2 = $m_sjsr_package$().wrapJavaScriptException__O__jl_Throwable(e);
    if ((e$2 !== null)) {
      $s_Ldiode_Circuit$class__handleFatal__Ldiode_Circuit__O__jl_Throwable__V($$this, action$4, e$2)
    } else {
      throw e
    }
  } finally {
...
function $s_Ldiode_Circuit$class__diode$Circuit$$baseHandler__Ldiode_Circuit__O__Ldiode_ActionResult$NoChange$($$this, action) {
  if ($is_Ldiode_ActionBatch(action)) {
    ...
    x2.actions__sc_Seq().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
      return (function(a$2) {
        return $s_Ldiode_Circuit$class__dispatchBase__Ldiode_Circuit__O__Z(arg$outer, a$2)
      })
    })($$this)));
    ...
    if ((x === action)) {
      ...
      $s_Ldiode_Circuit$class__handleError__Ldiode_Circuit__T__V($$this, msg);
      return $m_Ldiode_ActionResult$NoChange$()
    }
  }
}
...
function $s_Lscalatags_generic_Util$class__OptionNode__Lscalatags_generic_Util__s_Option__F1__Lscalatags_generic_Util$SeqNode($$this, xs, ev) {
  var this$2 = xs.toList__sci_List();
  return new $c_Lscalatags_generic_Util$SeqNode().init___Lscalatags_generic_Util__sc_Seq__F1($$this, this$2, ev)
}
...
function $is_s_concurrent_ExecutionContext(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.s_concurrent_ExecutionContext)))
}
function $as_s_concurrent_ExecutionContext(obj) {
  return (($is_s_concurrent_ExecutionContext(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "scala.concurrent.ExecutionContext"))
}
function $isArrayOf_s_concurrent_ExecutionContext(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.s_concurrent_ExecutionContext)))
}
function $asArrayOf_s_concurrent_ExecutionContext(obj, depth) {
  return (($isArrayOf_s_concurrent_ExecutionContext(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lscala.concurrent.ExecutionContext;", depth))
}
...
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_SeedData$() {
  $c_O.call(this);
  this.candies$1 = null
}
$c_Lcom_github_aafa_vending_diode_SeedData$.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_SeedData$.prototype.constructor = $c_Lcom_github_aafa_vending_diode_SeedData$;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_SeedData$() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_SeedData$.prototype = $c_Lcom_github_aafa_vending_diode_SeedData$.prototype;
$c_Lcom_github_aafa_vending_diode_SeedData$.prototype.init___ = (function() {
  $n_Lcom_github_aafa_vending_diode_SeedData$ = this;
  this.candies$1 = $m_sjsr_RuntimeString$().split__T__T__I__AT("Air Heads, Baby Ruth candy bar, Caramello, Dots, Eiffel Bon Bons, Fisher Milk Chocolate, Good & Plenty, Hershey's Chocolate Bar, Ice Breakers gum, Jolly Ranchers, Kit Kat, Laffy Taffy, M&M's, Nerds, Oreo Cookies, Payday candy bar, Quick Blast Sour Candy Spray, Red Vines licorice, Skittles, Tootsie Roll, Unicorn Pop. Van Wyk Confections, Warheads, York and Zero Bars", ", ", 0);
  return this
});
var $d_Lcom_github_aafa_vending_diode_SeedData$ = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_SeedData$: 0
}, false, "com.github.aafa.vending.diode.SeedData$", {
  Lcom_github_aafa_vending_diode_SeedData$: 1,
  O: 1
});
$c_Lcom_github_aafa_vending_diode_SeedData$.prototype.$classData = $d_Lcom_github_aafa_vending_diode_SeedData$;
var $n_Lcom_github_aafa_vending_diode_SeedData$ = (void 0);
function $m_Lcom_github_aafa_vending_diode_SeedData$() {
  if ((!$n_Lcom_github_aafa_vending_diode_SeedData$)) {
    $n_Lcom_github_aafa_vending_diode_SeedData$ = new $c_Lcom_github_aafa_vending_diode_SeedData$().init___()
  };
  return $n_Lcom_github_aafa_vending_diode_SeedData$
}
/** @constructor */
...
$c_Ldiode_ActionResult$.prototype.apply__s_Option__s_Option__Ldiode_ActionResult = (function(model, effect) {
  ...
  if ((x$3 === model)) {
    if ($is_s_Some(effect)) {
      ...
      var e$2 = $as_Ldiode_Effect(x11.x$2);
...
$c_Ldiode_Effect$.prototype.action__F0__Ldiode_ActionType__s_concurrent_ExecutionContext__Ldiode_EffectSingle = (function(action, evidence$10, ec) {
  return new $c_Ldiode_EffectSingle().init___F0__s_concurrent_ExecutionContext(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(action$1) {
    return (function() {
...
/** @constructor */
function $c_s_Predef$DummyImplicit() {
  $c_O.call(this)
}
$c_s_Predef$DummyImplicit.prototype = new $h_O();
$c_s_Predef$DummyImplicit.prototype.constructor = $c_s_Predef$DummyImplicit;
/** @constructor */
function $h_s_Predef$DummyImplicit() {
  /*<skip>*/
}
$h_s_Predef$DummyImplicit.prototype = $c_s_Predef$DummyImplicit.prototype;
$c_s_Predef$DummyImplicit.prototype.init___ = (function() {
  return this
});
var $d_s_Predef$DummyImplicit = new $TypeData().initClass({
...
$c_s_concurrent_Future$.prototype.traverse__sc_TraversableOnce__F1__scg_CanBuildFrom__s_concurrent_ExecutionContext__s_concurrent_Future = (function($in, fn, cbf, executor) {
  var this$1 = $as_s_concurrent_Future($in.foldLeft__O__F2__O(this.successful__O__s_concurrent_Future(cbf.apply__O__scm_Builder($in)), new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this, fn$1, executor$1) {
    return (function(fr$2, a$2) {
      var fr = $as_s_concurrent_Future(fr$2);
      var fb = $as_s_concurrent_Future(fn$1.apply__O__O(a$2));
      var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1, executor$4, fb$1) {
        return (function(r$2) {
          var r = $as_scm_Builder(r$2);
          var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$2, r$1) {
            return (function(b$2) {
              return r$1.$$plus$eq__O__scm_Builder(b$2)
            })
          })($this$1, r));
          return $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(fb$1, f, executor$4)
        })
      })($this, executor$1, fb));
  ...
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2) {
    return (function(x$9$2) {
      ...
      return $as_sc_TraversableOnce(x$9.result__O())
    })
  })(this));
...
/** @constructor */
function $c_Lcom_github_aafa_vending_Main$() {
  $c_O.call(this)
}
$c_Lcom_github_aafa_vending_Main$.prototype = new $h_O();
$c_Lcom_github_aafa_vending_Main$.prototype.constructor = $c_Lcom_github_aafa_vending_Main$;
/** @constructor */
function $h_Lcom_github_aafa_vending_Main$() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_Main$.prototype = $c_Lcom_github_aafa_vending_Main$.prototype;
$c_Lcom_github_aafa_vending_Main$.prototype.init___ = (function() {
  $n_Lcom_github_aafa_vending_Main$ = this;
  var this$3 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(a$2) {
    var a = $as_Lcom_github_aafa_vending_diode_RootModel(a$2);
    return a
  }));
  ...
  var listener = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    $as_Ldiode_ModelRO(x$1$2);
    $m_Lcom_github_aafa_vending_Main$().com$github$aafa$vending$Main$$render__V()
  }));
  $s_Ldiode_Circuit$class__subscribe__Ldiode_Circuit__Ldiode_ModelR__F1__F0(this$3, cursor, listener);
  return this
});
$c_Lcom_github_aafa_vending_Main$.prototype.content__Lorg_scalajs_dom_raw_Node__V = (function(targetNode) {
  var jsx$4 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag());
  var jsx$3 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("insertCoin", $m_Lscalatags_JsDom$all$().stringAttr$1);
  ...
  var jsx$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
    var action = new $c_Lcom_github_aafa_vending_diode_InsertCoin().init___Lcom_github_aafa_vending_diode_CandyCoin(new $c_Lcom_github_aafa_vending_diode_CandyCoin().init___I(1));
    var evidence$2 = $m_Ldiode_Action$aType$();
    $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V(this$1, action, evidence$2)
  }));
  ...
  var insertCoin = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, jsx$2.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$1, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$2, ev)), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(">> Insert CandyCoin here <<"))]));
  var this$4 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$2$2) {
    var x$2 = $as_Lcom_github_aafa_vending_diode_RootModel(x$2$2);
    return x$2.listOfCandies$1
  }));
  var feq = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  ...
  var candies = $as_sc_Seq($s_Ldiode_BaseModelR$class__value__Ldiode_BaseModelR__O(this$6));
  var this$7 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$3$2) {
    var x$3 = $as_Lcom_github_aafa_vending_diode_RootModel(x$3$2);
    return x$3.coinsSlot$1
  }));
  var feq$1 = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$8 = this$7.diode$Circuit$$modelRW$1;
  var this$9 = $s_Ldiode_BaseModelR$class__zoom__Ldiode_BaseModelR__F1__Ldiode_FastEq__Ldiode_ZoomModelR(this$8, get$1, feq$1);
  var coinsSlot = $as_Lcom_github_aafa_vending_diode_CandyCoin($s_Ldiode_BaseModelR$class__value__Ldiode_BaseModelR__O(this$9)).value$1;
  var this$10 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$4$2) {
    var x$4 = $as_Lcom_github_aafa_vending_diode_RootModel(x$4$2);
    return x$4.getTheCandySlot$1
  }));
  var feq$2 = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$11 = this$10.diode$Circuit$$modelRW$1;
  var this$12 = $s_Ldiode_BaseModelR$class__zoom__Ldiode_BaseModelR__F1__Ldiode_FastEq__Ldiode_ZoomModelR(this$11, get$2, feq$2);
  var this$13 = $as_s_Option($s_Ldiode_BaseModelR$class__value__Ldiode_BaseModelR__O(this$12));
  if (this$13.isEmpty__Z()) {
    var getTheCandy = $m_s_None$()
  } else {
    var arg1 = this$13.get__O();
    var x$5 = $as_Lcom_github_aafa_vending_diode_Candy(arg1);
    var getTheCandy = new $c_s_Some().init___O(x$5.name$1)
  };
  var this$14 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$6$2) {
    var x$6 = $as_Lcom_github_aafa_vending_diode_RootModel(x$6$2);
    return x$6.machineInfo$1
  }));
  var feq$3 = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$15 = this$14.diode$Circuit$$modelRW$1;
  var this$16 = $s_Ldiode_BaseModelR$class__zoom__Ldiode_BaseModelR__F1__Ldiode_FastEq__Ldiode_ZoomModelR(this$15, get$3, feq$3);
  var info = $as_T($s_Ldiode_BaseModelR$class__value__Ldiode_BaseModelR__O(this$16));
  var jsx$22 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$21 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$20 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h2__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Candies for everyone!"))]));
  var jsx$19 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(info))]));
  var jsx$18 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([insertCoin]));
  var jsx$17 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  $m_Lscalatags_JsDom$all$();
  var v = (coinsSlot + " coins");
  var jsx$16 = jsx$17.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v)]));
  var jsx$15 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().ul__Lscalatags_generic_TypedTag());
  var jsx$14 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("candyList", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$21 = $m_Lscalatags_JsDom$all$();
  var jsx$13 = new $c_Lcom_github_aafa_vending_Main$$anonfun$content$2().init___();
  var this$20 = $m_sc_Seq$();
  var xs = $as_sc_Seq(candies.map__F1__scg_CanBuildFrom__O(jsx$13, this$20.ReusableCBFInstance$2));
  var ev$1 = $m_s_Predef$().singleton$und$less$colon$less$2;
  var jsx$12 = jsx$15.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$14, new $c_Lscalatags_JsDom$Cap$SeqFrag().init___Lscalatags_JsDom$Cap__sc_Seq__F1(this$21, xs, ev$1)]));
  var jsx$11 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$10 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("footer", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$9 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag());
  var jsx$8 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("get-candy-slot", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$7 = $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr();
  var jsx$6 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    var this$22 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
    var action$1 = $m_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$();
    var evidence$2$1 = $m_Ldiode_Action$aType$();
    $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V(this$22, action$1, evidence$2$1)
  }));
  var this$23 = $m_Lscalatags_JsDom$all$();
  var ev$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$2$1) {
    var f$3 = $as_F0(f$2$1);
    return (function(f$4) {
      return (function() {
        return f$4.apply__O()
  ...
  var jsx$5 = jsx$7.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$6, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$23, ev$2));
  var this$25 = $m_Lscalatags_JsDom$all$();
  var ev$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(v$2) {
    var v$1 = $as_T(v$2);
    $m_Lscalatags_JsDom$all$();
    return new $c_Lscalatags_JsDom$StringFrag().init___T(v$1)
  }));
  targetNode.appendChild(jsx$22.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$21, jsx$20, jsx$19, jsx$18, jsx$16, jsx$12, jsx$11.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$10, jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8, jsx$5, $s_Lscalatags_generic_Util$class__OptionNode__Lscalatags_generic_Util__s_Option__F1__Lscalatags_generic_Util$SeqNode(this$25, getTheCandy, ev$3)]))]))])).render__Lorg_scalajs_dom_raw_Element())
});
$c_Lcom_github_aafa_vending_Main$.prototype.com$github$aafa$vending$Main$$render__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.innerHTML = "";
  this.content__Lorg_scalajs_dom_raw_Node__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body)
});
$c_Lcom_github_aafa_vending_Main$.prototype.$$js$exported$meth$main__O = (function() {
  this.com$github$aafa$vending$Main$$render__V()
});
$c_Lcom_github_aafa_vending_Main$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lcom_github_aafa_vending_Main$ = new $TypeData().initClass({
  Lcom_github_aafa_vending_Main$: 0
}, false, "com.github.aafa.vending.Main$", {
  Lcom_github_aafa_vending_Main$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lcom_github_aafa_vending_Main$.prototype.$classData = $d_Lcom_github_aafa_vending_Main$;
var $n_Lcom_github_aafa_vending_Main$ = (void 0);
function $m_Lcom_github_aafa_vending_Main$() {
  if ((!$n_Lcom_github_aafa_vending_Main$)) {
    $n_Lcom_github_aafa_vending_Main$ = new $c_Lcom_github_aafa_vending_Main$().init___()
  };
  return $n_Lcom_github_aafa_vending_Main$
}
$e.com = ($e.com || {});
$e.com.github = ($e.com.github || {});
$e.com.github.aafa = ($e.com.github.aafa || {});
$e.com.github.aafa.vending = ($e.com.github.aafa.vending || {});
$e.com.github.aafa.vending.Main = $m_Lcom_github_aafa_vending_Main$;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1() {
  $c_Ldiode_ActionHandler.call(this)
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype = new $h_Ldiode_ActionHandler();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype.init___ = (function() {
  var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_Lcom_github_aafa_vending_diode_RootModel(x$1$2);
    return x$1.getTheCandySlot$1
  }));
  var set = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(model$2, c$2) {
    var model = $as_Lcom_github_aafa_vending_diode_RootModel(model$2);
    var c = $as_s_Option(c$2);
    var x$18 = model.listOfCandies$1;
    var x$19 = model.coinsSlot$1;
    var x$20 = model.coinsInMyPocket$1;
    var x$21 = model.machineInfo$1;
    return new $c_Lcom_github_aafa_vending_diode_RootModel().init___sc_Seq__Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin__T__s_Option(x$18, x$19, x$20, x$21, c)
  }));
  var feq = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$2 = this$1.diode$Circuit$$modelRW$1;
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype.handle__s_PartialFunction = (function() {
  return new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2().init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$1(this)
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$1: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$1", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$1: 1,
  Ldiode_ActionHandler: 1,
  O: 1
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2() {
  $c_Ldiode_ActionHandler.call(this)
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype = new $h_Ldiode_ActionHandler();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype.init___ = (function() {
  var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$4$2) {
    var x$4 = $as_Lcom_github_aafa_vending_diode_RootModel(x$4$2);
    return x$4.listOfCandies$1
  }));
  var set = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(model$2, stocks$2) {
    var model = $as_Lcom_github_aafa_vending_diode_RootModel(model$2);
    var stocks = $as_sc_Seq(stocks$2);
    var coinsSlot = model.coinsSlot$1;
    var coinsInMyPocket = model.coinsInMyPocket$1;
    var machineInfo = model.machineInfo$1;
    var getTheCandySlot = model.getTheCandySlot$1;
    return new $c_Lcom_github_aafa_vending_diode_RootModel().init___sc_Seq__Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin__T__s_Option(stocks, coinsSlot, coinsInMyPocket, machineInfo, getTheCandySlot)
  }));
  var feq = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$2 = this$1.diode$Circuit$$modelRW$1;
  $c_Ldiode_ActionHandler.prototype.init___Ldiode_ModelRW.call(this, new $c_Ldiode_ZoomModelRW().init___Ldiode_ModelR__F1__F2__Ldiode_FastEq(this$2, get, set, feq));
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype.handle__s_PartialFunction = (function() {
  return new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1().init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$2(this)
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$2: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$2", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$2: 1,
  Ldiode_ActionHandler: 1,
  O: 1
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3() {
  $c_Ldiode_ActionHandler.call(this)
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype = new $h_Ldiode_ActionHandler();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype.init___ = (function() {
  var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$2$2) {
    var x$2 = $as_Lcom_github_aafa_vending_diode_RootModel(x$2$2);
    return x$2.machineInfo$1
  }));
  var set = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(model$2, i$2) {
    var model = $as_Lcom_github_aafa_vending_diode_RootModel(model$2);
    var i = $as_T(i$2);
    var x$33 = model.listOfCandies$1;
    var x$34 = model.coinsSlot$1;
    var x$35 = model.coinsInMyPocket$1;
    var x$36 = model.getTheCandySlot$1;
    return new $c_Lcom_github_aafa_vending_diode_RootModel().init___sc_Seq__Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin__T__s_Option(x$33, x$34, x$35, i, x$36)
  }));
  var feq = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$2 = this$1.diode$Circuit$$modelRW$1;
  $c_Ldiode_ActionHandler.prototype.init___Ldiode_ModelRW.call(this, new $c_Ldiode_ZoomModelRW().init___Ldiode_ModelR__F1__F2__Ldiode_FastEq(this$2, get, set, feq));
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype.handle__s_PartialFunction = (function() {
  return new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3().init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$3(this)
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$3: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$3", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$3: 1,
  Ldiode_ActionHandler: 1,
  O: 1
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4() {
  $c_Ldiode_ActionHandler.call(this)
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype = new $h_Ldiode_ActionHandler();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype.init___ = (function() {
  var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$3$2) {
    var x$3 = $as_Lcom_github_aafa_vending_diode_RootModel(x$3$2);
    return x$3.coinsSlot$1
  }));
  var set = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(model$2, coin$2) {
    var model = $as_Lcom_github_aafa_vending_diode_RootModel(model$2);
    var coin = $as_Lcom_github_aafa_vending_diode_CandyCoin(coin$2);
    var x$48 = model.listOfCandies$1;
    var x$49 = model.coinsInMyPocket$1;
    var x$50 = model.machineInfo$1;
    var x$51 = model.getTheCandySlot$1;
    return new $c_Lcom_github_aafa_vending_diode_RootModel().init___sc_Seq__Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin__T__s_Option(x$48, coin, x$49, x$50, x$51)
  }));
  var feq = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
  var this$2 = this$1.diode$Circuit$$modelRW$1;
  $c_Ldiode_ActionHandler.prototype.init___Ldiode_ModelRW.call(this, new $c_Ldiode_ZoomModelRW().init___Ldiode_ModelR__F1__F2__Ldiode_FastEq(this$2, get, set, feq));
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype.handle__s_PartialFunction = (function() {
  return new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4().init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$4(this)
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$4: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$4", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$4: 1,
  Ldiode_ActionHandler: 1,
  O: 1
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4;
/** @constructor */
...
$c_Ldiode_EffectBase.prototype.$$plus__Ldiode_Effect__Ldiode_EffectSet = (function(that) {
  var array = [that];
  ...
  return new $c_Ldiode_EffectSet().init___Ldiode_Effect__sci_Set__s_concurrent_ExecutionContext(this, $as_sci_Set(jsx$1), this.ec$1)
});
...
/** @constructor */
function $c_s_FallbackArrayBuilding$$anon$1() {
  $c_O.call(this)
}
$c_s_FallbackArrayBuilding$$anon$1.prototype = new $h_O();
$c_s_FallbackArrayBuilding$$anon$1.prototype.constructor = $c_s_FallbackArrayBuilding$$anon$1;
/** @constructor */
function $h_s_FallbackArrayBuilding$$anon$1() {
  /*<skip>*/
}
$h_s_FallbackArrayBuilding$$anon$1.prototype = $c_s_FallbackArrayBuilding$$anon$1.prototype;
$c_s_FallbackArrayBuilding$$anon$1.prototype.apply__scm_Builder = (function() {
  return $m_scm_ArraySeq$().newBuilder__scm_Builder()
});
$c_s_FallbackArrayBuilding$$anon$1.prototype.init___s_FallbackArrayBuilding = (function($$outer) {
  return this
});
$c_s_FallbackArrayBuilding$$anon$1.prototype.apply__O__scm_Builder = (function(from) {
  return $m_scm_ArraySeq$().newBuilder__scm_Builder()
});
var $d_s_FallbackArrayBuilding$$anon$1 = new $TypeData().initClass({
...
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$() {
  $c_O.call(this);
  this.getTheCandySlotHandler$1 = null;
  this.infoHandler$1 = null;
  this.coinsHandler$1 = null;
  this.listOfCandies$1 = null;
  this.model$1 = null;
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype.init___ = (function() {
  $n_Lcom_github_aafa_vending_diode_AppCircuit$ = this;
  $s_Ldiode_Circuit$class__$$init$__Ldiode_Circuit__V(this);
  this.getTheCandySlotHandler$1 = new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1().init___();
  this.infoHandler$1 = new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3().init___();
  this.coinsHandler$1 = new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4().init___();
  this.listOfCandies$1 = new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2().init___();
  return this
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype.diode$Circuit$$Subscription$lzycompute__p1__Ldiode_Circuit$Subscription$ = (function() {
  if ((this.diode$Circuit$$Subscription$module$1 === null)) {
    this.diode$Circuit$$Subscription$module$1 = new $c_Ldiode_Circuit$Subscription$().init___Ldiode_Circuit(this)
  };
  return this.diode$Circuit$$Subscription$module$1
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype.diode$Circuit$$Subscription__Ldiode_Circuit$Subscription$ = (function() {
  return ((this.diode$Circuit$$Subscription$module$1 === null) ? this.diode$Circuit$$Subscription$lzycompute__p1__Ldiode_Circuit$Subscription$() : this.diode$Circuit$$Subscription$module$1)
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype.actionHandler__F2 = (function() {
  var handlers = new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Ldiode_ActionHandler$().extractHandler__Ldiode_ActionHandler__F2(this.coinsHandler$1), $m_Ldiode_ActionHandler$().extractHandler__Ldiode_ActionHandler__F2(this.getTheCandySlotHandler$1), $m_Ldiode_ActionHandler$().extractHandler__Ldiode_ActionHandler__F2(this.infoHandler$1), $m_Ldiode_ActionHandler$().extractHandler__Ldiode_ActionHandler__F2(this.listOfCandies$1)]);
  return new $c_Ldiode_Circuit$$anonfun$foldHandlers$1().init___Ldiode_Circuit__sc_Seq(this, handlers)
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$ = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$", {
  Lcom_github_aafa_vending_diode_AppCircuit$: 1,
  O: 1,
  Ldiode_Circuit: 1,
  Ldiode_Dispatcher: 1
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$;
var $n_Lcom_github_aafa_vending_diode_AppCircuit$ = (void 0);
function $m_Lcom_github_aafa_vending_diode_AppCircuit$() {
  if ((!$n_Lcom_github_aafa_vending_diode_AppCircuit$)) {
    $n_Lcom_github_aafa_vending_diode_AppCircuit$ = new $c_Lcom_github_aafa_vending_diode_AppCircuit$().init___()
  };
  return $n_Lcom_github_aafa_vending_diode_AppCircuit$
}
/** @constructor */
...
$c_Ldiode_Circuit$Subscription$.prototype.init___Ldiode_Circuit = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$1 = $$outer
...
$c_Ldiode_Circuit$Subscription$.prototype.apply__F1__Ldiode_ModelR__O__Ldiode_Circuit$Subscription = (function(listener, cursor, lastValue) {
  return new $c_Ldiode_Circuit$Subscription().init___Ldiode_Circuit__F1__Ldiode_ModelR__O(this.$$outer$1, listener, cursor, lastValue)
});
...
/** @constructor */
function $c_Ldiode_EffectSet() {
  $c_Ldiode_EffectBase.call(this);
  this.head$2 = null;
  this.tail$2 = null
}
$c_Ldiode_EffectSet.prototype = new $h_Ldiode_EffectBase();
$c_Ldiode_EffectSet.prototype.constructor = $c_Ldiode_EffectSet;
/** @constructor */
function $h_Ldiode_EffectSet() {
  /*<skip>*/
}
$h_Ldiode_EffectSet.prototype = $c_Ldiode_EffectSet.prototype;
$c_Ldiode_EffectSet.prototype.run__F1__s_concurrent_Future = (function(dispatch) {
  var this$1 = this.executeWith__p2__F1__s_concurrent_Future(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(dispatch$3) {
    return (function(x$11$2) {
      var x$11 = $as_Ldiode_Effect(x$11$2);
      return x$11.run__F1__s_concurrent_Future(dispatch$3)
    })
  })(dispatch)));
...
$c_Ldiode_EffectSet.prototype.init___Ldiode_Effect__sci_Set__s_concurrent_ExecutionContext = (function(head, tail, ec) {
  this.head$2 = head;
  this.tail$2 = tail;
  $c_Ldiode_EffectBase.prototype.init___s_concurrent_ExecutionContext.call(this, ec);
  return this
});
$c_Ldiode_EffectSet.prototype.$$plus__Ldiode_Effect__Ldiode_EffectSet = (function(that) {
  return new $c_Ldiode_EffectSet().init___Ldiode_Effect__sci_Set__s_concurrent_ExecutionContext(this.head$2, $as_sci_Set(this.tail$2.$$plus__O__sc_Set(that)), this.ec$1)
});
$c_Ldiode_EffectSet.prototype.executeWith__p2__F1__s_concurrent_Future = (function(f) {
  var jsx$3 = $m_s_concurrent_Future$();
  var jsx$2 = this.tail$2.$$plus__O__sc_Set(this.head$2);
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$3) {
    return (function(x$10$2) {
      var x$10 = $as_Ldiode_Effect(x$10$2);
      return $as_s_concurrent_Future(f$3.apply__O__O(x$10))
    })
  })(f));
  var this$1 = $m_sci_Set$();
  var e = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$1);
  return jsx$3.traverse__sc_TraversableOnce__F1__scg_CanBuildFrom__s_concurrent_ExecutionContext__s_concurrent_Future(jsx$2, jsx$1, e, this.ec$1)
});
var $d_Ldiode_EffectSet = new $TypeData().initClass({
  Ldiode_EffectSet: 0
}, false, "diode.EffectSet", {
  Ldiode_EffectSet: 1,
  Ldiode_EffectBase: 1,
  O: 1,
  Ldiode_Effect: 1
});
$c_Ldiode_EffectSet.prototype.$classData = $d_Ldiode_EffectSet;
/** @constructor */
...
$c_Ldiode_EffectSingle.prototype.run__F1__s_concurrent_Future = (function(dispatch) {
  var this$1 = $as_s_concurrent_Future(this.f$2.apply__O());
  var executor = this.ec$1;
  return $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$1, dispatch, executor)
});
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lcom_github_aafa_vending_Main$$anonfun$content$2() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype = new $h_sr_AbstractFunction1();
$c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype.constructor = $c_Lcom_github_aafa_vending_Main$$anonfun$content$2;
/** @constructor */
function $h_Lcom_github_aafa_vending_Main$$anonfun$content$2() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype = $c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype;
$c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype.apply__O__O = (function(v1) {
  return this.apply__Lcom_github_aafa_vending_diode_CandyStock__Lscalatags_JsDom$TypedTag($as_Lcom_github_aafa_vending_diode_CandyStock(v1))
});
$c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype.apply__Lcom_github_aafa_vending_diode_CandyStock__Lscalatags_JsDom$TypedTag = (function(c) {
  ...
  var jsx$4 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("candy", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$3 = $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr();
  var jsx$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(c$1) {
    return (function() {
      var this$1 = $m_Lcom_github_aafa_vending_diode_AppCircuit$();
      var action = new $c_Lcom_github_aafa_vending_diode_PurchaseCandy().init___Lcom_github_aafa_vending_diode_Candy__I(c$1.candy$1, 1);
      var evidence$2 = $m_Ldiode_Action$aType$();
      $s_Ldiode_Circuit$class__dispatch__Ldiode_Circuit__O__Ldiode_ActionType__V(this$1, action, evidence$2)
    })
  })(c));
  ...
  var jsx$1 = jsx$3.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$2, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$2, ev));
  $m_Lscalatags_JsDom$all$();
  var v = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Purchase ", " for ", "cc, only ", " left"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([c.candy$1.name$1, c.price$1.value$1, c.quantity$1]));
  return jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$4, jsx$1, new $c_Lscalatags_JsDom$StringFrag().init___T(v)]))]))
});
var $d_Lcom_github_aafa_vending_Main$$anonfun$content$2 = new $TypeData().initClass({
  Lcom_github_aafa_vending_Main$$anonfun$content$2: 0
}, false, "com.github.aafa.vending.Main$$anonfun$content$2", {
  Lcom_github_aafa_vending_Main$$anonfun$content$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_Main$$anonfun$content$2.prototype.$classData = $d_Lcom_github_aafa_vending_Main$$anonfun$content$2;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype = new $h_sr_AbstractFunction1();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype.apply__O__O = (function(v1) {
  return this.apply__Ldiode_Action__Ldiode_EffectSingle($as_Ldiode_Action(v1))
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype.init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1 = (function($$outer) {
  return this
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype.apply__Ldiode_Action__Ldiode_EffectSingle = (function(a) {
  return $m_Ldiode_Effect$().action__F0__Ldiode_ActionType__s_concurrent_ExecutionContext__Ldiode_EffectSingle(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1) {
    return (function() {
      return a$1
    })
  })(a)), $m_Ldiode_Action$aType$(), $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor())
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_Candy() {
  $c_O.call(this);
  this.name$1 = null
}
$c_Lcom_github_aafa_vending_diode_Candy.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_Candy.prototype.constructor = $c_Lcom_github_aafa_vending_diode_Candy;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_Candy() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_Candy.prototype = $c_Lcom_github_aafa_vending_diode_Candy.prototype;
$c_Lcom_github_aafa_vending_diode_Candy.prototype.productPrefix__T = (function() {
  return "Candy"
});
$c_Lcom_github_aafa_vending_diode_Candy.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_Candy.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_Candy(x$1)) {
    var Candy$1 = $as_Lcom_github_aafa_vending_diode_Candy(x$1);
    return (this.name$1 === Candy$1.name$1)
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_Candy.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.name$1;
      break
...
$c_Lcom_github_aafa_vending_diode_Candy.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_Candy.prototype.init___T = (function(name) {
  this.name$1 = name;
  return this
});
$c_Lcom_github_aafa_vending_diode_Candy.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_Candy.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_Candy(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_Candy)))
}
function $as_Lcom_github_aafa_vending_diode_Candy(obj) {
  return (($is_Lcom_github_aafa_vending_diode_Candy(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.Candy"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_Candy(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_Candy)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_Candy(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_Candy(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.Candy;", depth))
}
var $d_Lcom_github_aafa_vending_diode_Candy = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_Candy: 0
}, false, "com.github.aafa.vending.diode.Candy", {
  Lcom_github_aafa_vending_diode_Candy: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_diode_Candy.prototype.$classData = $d_Lcom_github_aafa_vending_diode_Candy;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_CandyCoin() {
  $c_O.call(this);
  this.value$1 = 0
}
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.constructor = $c_Lcom_github_aafa_vending_diode_CandyCoin;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_CandyCoin() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_CandyCoin.prototype = $c_Lcom_github_aafa_vending_diode_CandyCoin.prototype;
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.productPrefix__T = (function() {
  return "CandyCoin"
});
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_CandyCoin(x$1)) {
    var CandyCoin$1 = $as_Lcom_github_aafa_vending_diode_CandyCoin(x$1);
    return (this.value$1 === CandyCoin$1.value$1)
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.value$1;
      break
...
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.toString__T = (function() {
  return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", "cc"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.value$1]))
});
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.init___I = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.value$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 1)
});
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_CandyCoin(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_CandyCoin)))
}
function $as_Lcom_github_aafa_vending_diode_CandyCoin(obj) {
  return (($is_Lcom_github_aafa_vending_diode_CandyCoin(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.CandyCoin"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_CandyCoin(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_CandyCoin)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_CandyCoin(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_CandyCoin(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.CandyCoin;", depth))
}
var $d_Lcom_github_aafa_vending_diode_CandyCoin = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_CandyCoin: 0
}, false, "com.github.aafa.vending.diode.CandyCoin", {
  Lcom_github_aafa_vending_diode_CandyCoin: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_diode_CandyCoin.prototype.$classData = $d_Lcom_github_aafa_vending_diode_CandyCoin;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_CandyStock() {
  $c_O.call(this);
  this.candy$1 = null;
  this.quantity$1 = 0;
  this.price$1 = null
}
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.constructor = $c_Lcom_github_aafa_vending_diode_CandyStock;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_CandyStock() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_CandyStock.prototype = $c_Lcom_github_aafa_vending_diode_CandyStock.prototype;
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.productPrefix__T = (function() {
  return "CandyStock"
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.init___Lcom_github_aafa_vending_diode_Candy__I__Lcom_github_aafa_vending_diode_CandyCoin = (function(candy, quantity, price) {
  this.candy$1 = candy;
  this.quantity$1 = quantity;
  this.price$1 = price;
  return this
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.productArity__I = (function() {
  return 3
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.available__I__Z = (function(q) {
  return (this.quantity$1 >= q)
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_CandyStock(x$1)) {
    var CandyStock$1 = $as_Lcom_github_aafa_vending_diode_CandyStock(x$1);
    var x = this.candy$1;
    var x$2 = CandyStock$1.candy$1;
    if ((((x === null) ? (x$2 === null) : x.equals__O__Z(x$2)) && (this.quantity$1 === CandyStock$1.quantity$1))) {
      var x$3 = this.price$1;
      var x$4 = CandyStock$1.price$1;
...
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.candy$1;
      break
...
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.toString__T = (function() {
  return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", " '", "' for ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.quantity$1, this.candy$1.name$1, this.price$1]))
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.candy$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.quantity$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.price$1));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 3)
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.buy__I__Lcom_github_aafa_vending_diode_CandyStock = (function(i) {
  var candy = this.candy$1;
  var quantity = ((this.quantity$1 - i) | 0);
  var price = this.price$1;
  return new $c_Lcom_github_aafa_vending_diode_CandyStock().init___Lcom_github_aafa_vending_diode_Candy__I__Lcom_github_aafa_vending_diode_CandyCoin(candy, quantity, price)
});
function $is_Lcom_github_aafa_vending_diode_CandyStock(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_CandyStock)))
}
function $as_Lcom_github_aafa_vending_diode_CandyStock(obj) {
  return (($is_Lcom_github_aafa_vending_diode_CandyStock(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.CandyStock"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_CandyStock(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_CandyStock)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_CandyStock(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_CandyStock(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.CandyStock;", depth))
}
var $d_Lcom_github_aafa_vending_diode_CandyStock = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_CandyStock: 0
}, false, "com.github.aafa.vending.diode.CandyStock", {
  Lcom_github_aafa_vending_diode_CandyStock: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_diode_CandyStock.prototype.$classData = $d_Lcom_github_aafa_vending_diode_CandyStock;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_RootModel() {
  $c_O.call(this);
  this.listOfCandies$1 = null;
  this.coinsSlot$1 = null;
  this.coinsInMyPocket$1 = null;
  this.machineInfo$1 = null;
  this.getTheCandySlot$1 = null
}
$c_Lcom_github_aafa_vending_diode_RootModel.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.constructor = $c_Lcom_github_aafa_vending_diode_RootModel;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_RootModel() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_RootModel.prototype = $c_Lcom_github_aafa_vending_diode_RootModel.prototype;
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.productPrefix__T = (function() {
  return "RootModel"
});
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.productArity__I = (function() {
  return 5
});
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_RootModel(x$1)) {
    var RootModel$1 = $as_Lcom_github_aafa_vending_diode_RootModel(x$1);
    var x = this.listOfCandies$1;
    var x$2 = RootModel$1.listOfCandies$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.coinsSlot$1;
      var x$4 = RootModel$1.coinsSlot$1;
      var jsx$2 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      var jsx$2 = false
    };
    if (jsx$2) {
      var x$5 = this.coinsInMyPocket$1;
      var x$6 = RootModel$1.coinsInMyPocket$1;
      var jsx$1 = ((x$5 === null) ? (x$6 === null) : x$5.equals__O__Z(x$6))
    } else {
      var jsx$1 = false
    };
    if ((jsx$1 && (this.machineInfo$1 === RootModel$1.machineInfo$1))) {
      var x$7 = this.getTheCandySlot$1;
      var x$8 = RootModel$1.getTheCandySlot$1;
...
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.listOfCandies$1;
      break
    }
    case 1: {
      return this.coinsSlot$1;
      break
    }
    case 2: {
      return this.coinsInMyPocket$1;
      break
    }
    case 3: {
      return this.machineInfo$1;
      break
    }
    case 4: {
      return this.getTheCandySlot$1;
      break
    }
    default: {
      throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
...
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.init___sc_Seq__Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin__T__s_Option = (function(listOfCandies, coinsSlot, coinsInMyPocket, machineInfo, getTheCandySlot) {
  this.listOfCandies$1 = listOfCandies;
  this.coinsSlot$1 = coinsSlot;
  this.coinsInMyPocket$1 = coinsInMyPocket;
  this.machineInfo$1 = machineInfo;
  this.getTheCandySlot$1 = getTheCandySlot;
  return this
});
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_RootModel(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_RootModel)))
}
function $as_Lcom_github_aafa_vending_diode_RootModel(obj) {
  return (($is_Lcom_github_aafa_vending_diode_RootModel(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.RootModel"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_RootModel(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_RootModel)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_RootModel(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_RootModel(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.RootModel;", depth))
}
var $d_Lcom_github_aafa_vending_diode_RootModel = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_RootModel: 0
}, false, "com.github.aafa.vending.diode.RootModel", {
  Lcom_github_aafa_vending_diode_RootModel: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_diode_RootModel.prototype.$classData = $d_Lcom_github_aafa_vending_diode_RootModel;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_RootModel$() {
  $c_sr_AbstractFunction5.call(this)
}
$c_Lcom_github_aafa_vending_diode_RootModel$.prototype = new $h_sr_AbstractFunction5();
$c_Lcom_github_aafa_vending_diode_RootModel$.prototype.constructor = $c_Lcom_github_aafa_vending_diode_RootModel$;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_RootModel$() {
  /*<skip>*/
...
$h_Lcom_github_aafa_vending_diode_RootModel$.prototype = $c_Lcom_github_aafa_vending_diode_RootModel$.prototype;
$c_Lcom_github_aafa_vending_diode_RootModel$.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_aafa_vending_diode_RootModel$.prototype.toString__T = (function() {
  return "RootModel"
});
$c_Lcom_github_aafa_vending_diode_RootModel$.prototype.apply$default$1__sc_Seq = (function() {
  var xs = $m_Lcom_github_aafa_vending_diode_SeedData$().candies$1;
  var this$3 = $m_s_Array$();
  new $c_s_Predef$DummyImplicit().init___();
  new $c_s_FallbackArrayBuilding$$anon$1().init___s_FallbackArrayBuilding(this$3);
  ...
  while ((i < len)) {
    ...
    var arg1 = xs.u[index];
    var c = $as_T(arg1);
    var jsx$1 = new $c_Lcom_github_aafa_vending_diode_Candy().init___T(c);
    var this$7 = $m_s_util_Random$();
    b.$$plus$eq__O__scm_Builder(new $c_Lcom_github_aafa_vending_diode_CandyStock().init___Lcom_github_aafa_vending_diode_Candy__I__Lcom_github_aafa_vending_diode_CandyCoin(jsx$1, 10, new $c_Lcom_github_aafa_vending_diode_CandyCoin().init___I(((1 + this$7.self$1.nextInt__I__I(3)) | 0))));
    i = ((1 + i) | 0)
  };
...
$c_Lcom_github_aafa_vending_diode_RootModel$.prototype.$classData = $d_Lcom_github_aafa_vending_diode_RootModel$;
var $n_Lcom_github_aafa_vending_diode_RootModel$ = (void 0);
function $m_Lcom_github_aafa_vending_diode_RootModel$() {
  if ((!$n_Lcom_github_aafa_vending_diode_RootModel$)) {
    $n_Lcom_github_aafa_vending_diode_RootModel$ = new $c_Lcom_github_aafa_vending_diode_RootModel$().init___()
  };
  return $n_Lcom_github_aafa_vending_diode_RootModel$
}
/** @constructor */
...
/** @constructor */
function $c_Ldiode_Circuit$$anonfun$foldHandlers$1() {
  $c_sr_AbstractFunction2.call(this);
  this.handlers$2$2 = null
}
$c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype = new $h_sr_AbstractFunction2();
$c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype.constructor = $c_Ldiode_Circuit$$anonfun$foldHandlers$1;
/** @constructor */
function $h_Ldiode_Circuit$$anonfun$foldHandlers$1() {
  /*<skip>*/
}
$h_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype = $c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype;
$c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype.apply__O__O__s_Option = (function(initialModel, action) {
  return $as_s_Option($as_T2(this.handlers$2$2.foldLeft__O__F2__O(new $c_T2().init___O__O(initialModel, $m_s_None$()), new $c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4().init___Ldiode_Circuit$$anonfun$foldHandlers$1__O(this, action))).$$und2$f)
});
$c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype.init___Ldiode_Circuit__sc_Seq = (function($$outer, handlers$2) {
  this.handlers$2$2 = handlers$2;
  return this
});
$c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype.apply__O__O__O = (function(v1, v2) {
  return this.apply__O__O__s_Option(v1, v2)
});
var $d_Ldiode_Circuit$$anonfun$foldHandlers$1 = new $TypeData().initClass({
  Ldiode_Circuit$$anonfun$foldHandlers$1: 0
}, false, "diode.Circuit$$anonfun$foldHandlers$1", {
  Ldiode_Circuit$$anonfun$foldHandlers$1: 1,
  sr_AbstractFunction2: 1,
  O: 1,
  F2: 1,
  s_Serializable: 1,
...
$c_Ldiode_Circuit$$anonfun$foldHandlers$1.prototype.$classData = $d_Ldiode_Circuit$$anonfun$foldHandlers$1;
/** @constructor */
function $c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4() {
  $c_sr_AbstractFunction2.call(this);
  this.action$3$2 = null
}
$c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype = new $h_sr_AbstractFunction2();
$c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype.constructor = $c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4;
/** @constructor */
function $h_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4() {
  /*<skip>*/
}
$h_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype = $c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype;
$c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype.init___Ldiode_Circuit$$anonfun$foldHandlers$1__O = (function($$outer, action$3) {
  this.action$3$2 = action$3;
  return this
});
$c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype.apply__O__O__O = (function(v1, v2) {
  return this.apply__T2__F2__T2($as_T2(v1), $as_F2(v2))
});
$c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype.apply__T2__F2__T2 = (function(x0$1, x1$1) {
  ...
  if ((p2 !== null)) {
    ...
    var x1$2 = $as_s_Option(handler.apply__O__O__O(currentModel, this.action$3$2));
    var x = $m_s_None$();
    if ((x === x1$2)) {
      return new $c_T2().init___O__O(currentModel, currentResult)
    } else if ($is_s_Some(x1$2)) {
      var x2 = $as_s_Some(x1$2);
      var result = $as_Ldiode_ActionResult(x2.x$2);
      if ($is_s_Some(currentResult)) {
        var x2$2 = $as_s_Some(currentResult);
        var cr = $as_Ldiode_ActionResult(x2$2.x$2);
        ...
        matchEnd19: {
          ...
          if ($is_s_Some(p2$2)) {
            ...
            var e1 = $as_Ldiode_Effect(x4.x$2);
            if ($is_s_Some(p3)) {
              var x5 = $as_s_Some(p3);
              var e2 = $as_Ldiode_Effect(x5.x$2);
          ...
          if ($is_s_Some(p6)) {
            var x8 = $as_s_Some(p6);
            var e1$2 = $as_Ldiode_Effect(x8.x$2);
            var x$3 = $m_s_None$();
            if ((x$3 === p7)) {
          ...
          if ((x$5 === p9)) {
            if ($is_s_Some(p10)) {
              ...
              var e2$2 = $as_Ldiode_Effect(x11.x$2);
        ...
        var this$1 = result.newModelOpt__s_Option();
        var newModel = (this$1.isEmpty__Z() ? cr.newModelOpt__s_Option() : this$1);
        ...
        var _1$1 = (this$2.isEmpty__Z() ? currentModel : this$2.get__O());
...
var $d_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4 = new $TypeData().initClass({
  Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4: 0
}, false, "diode.Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4", {
  Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4: 1,
  sr_AbstractFunction2: 1,
  O: 1,
  F2: 1,
  s_Serializable: 1,
...
$c_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4.prototype.$classData = $d_Ldiode_Circuit$$anonfun$foldHandlers$1$$anonfun$apply$4;
/** @constructor */
function $c_Ldiode_Circuit$Subscription() {
  $c_O.call(this);
...
$c_Ldiode_Circuit$Subscription.prototype.changed__s_Option = (function() {
  if (this.cursor$1.$$eq$eq$eq__O__Z(this.lastValue$1)) {
    ...
    var x$5 = this.cursor$1.eval__O__O(this.$$outer$f.model$1);
    var x$6 = this.listener$1;
    var x$7 = this.cursor$1;
    return new $c_s_Some().init___O(new $c_Ldiode_Circuit$Subscription().init___Ldiode_Circuit__F1__Ldiode_ModelR__O(this.$$outer$f, x$6, x$7, x$5))
  }
});
...
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2() {
  $c_sr_AbstractPartialFunction.call(this);
  this.$$outer$2 = null
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype.init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$1 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype.isDefinedAt__O__Z = (function(x2) {
  if ($is_Lcom_github_aafa_vending_diode_GetYourCandy(x2)) {
    return true
  } else {
    var x = $m_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$();
    return (x === x2)
  }
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype.applyOrElse__O__F1__O = (function(x2, $default) {
  if ($is_Lcom_github_aafa_vending_diode_GetYourCandy(x2)) {
    var x2$2 = $as_Lcom_github_aafa_vending_diode_GetYourCandy(x2);
    var candy = x2$2.candy$1;
    return this.$$outer$2.updated__O__Ldiode_ActionResult(new $c_s_Some().init___O(candy))
  } else {
    var x = $m_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$();
    if ((x === x2)) {
      return this.$$outer$2.updated__O__Ldiode_ActionResult($m_s_None$())
    } else {
      return $default.apply__O__O(x2)
    }
  }
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$1$$anonfun$handle$2", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2: 1,
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$1$$anonfun$handle$2;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1() {
  $c_sr_AbstractPartialFunction.call(this);
  this.$$outer$2 = null
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype.init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$2 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype.isDefinedAt__O__Z = (function(x1) {
  return $is_Lcom_github_aafa_vending_diode_PurchaseCandy(x1)
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype.applyOrElse__O__F1__O = (function(x1, $default) {
  if ($is_Lcom_github_aafa_vending_diode_PurchaseCandy(x1)) {
    var x2 = $as_Lcom_github_aafa_vending_diode_PurchaseCandy(x1);
    var candy = x2.candy$1;
    var q = x2.quantity$1;
    var coinsSlot = $as_Lcom_github_aafa_vending_diode_RootModel(this.$$outer$2.modelRW$1.root__Ldiode_ModelR().value__O()).coinsSlot$1;
    var candySlot = $as_Lcom_github_aafa_vending_diode_RootModel(this.$$outer$2.modelRW$1.root__Ldiode_ModelR().value__O()).getTheCandySlot$1;
    var this$1 = this.$$outer$2;
    var jsx$2 = $as_sc_TraversableLike(this$1.modelRW$1.eval__O__O(this$1.currentModel$1));
    var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(candy$1, q$1, coinsSlot$1, candySlot$1) {
      return (function(x0$1$2) {
        var x0$1 = $as_Lcom_github_aafa_vending_diode_CandyStock(x0$1$2);
        if ((x0$1 !== null)) {
          var x = x0$1.candy$1;
          if (((x === null) ? (candy$1 === null) : x.equals__O__Z(candy$1))) {
            var price = x0$1.price$1;
            var canPurchase = (coinsSlot$1.value$1 >= price.value$1);
            var available = x0$1.available__I__Z(q$1);
            return (candySlot$1.isDefined__Z() ? new $c_T2().init___O__O(x0$1, $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst().init___Lcom_github_aafa_vending_diode_Candy(candy$1)]))) : ((!canPurchase) ? new $c_T2().init___O__O(x0$1, $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lcom_github_aafa_vending_diode_NotEnoughCoins().init___Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin(coinsSlot$1, price)]))) : ((!available) ? new $c_T2().init___O__O(x0$1, $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lcom_github_aafa_vending_diode_NoCandiesLeft().init___Lcom_github_aafa_vending_diode_Candy(candy$1)]))) : new $c_T2().init___O__O(x0$1.buy__I__Lcom_github_aafa_vending_diode_CandyStock(q$1), $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lcom_github_aafa_vending_diode_CoinsSpent().init___Lcom_github_aafa_vending_diode_CandyCoin(price), new $c_Lcom_github_aafa_vending_diode_GetYourCandy().init___Lcom_github_aafa_vending_diode_Candy(candy$1)]))))))
          }
        };
        return new $c_T2().init___O__O(x0$1, $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Ldiode_NoAction$()])))
      })
    })(candy, q, coinsSlot, candySlot));
    var this$2 = $m_sc_Seq$();
    var updatedValue = $as_sc_Seq(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, this$2.ReusableCBFInstance$2));
    var jsx$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$5$2) {
      var x$5 = $as_T2(x$5$2);
      return $as_Lcom_github_aafa_vending_diode_CandyStock(x$5.$$und1$f)
    }));
    var this$3 = $m_sc_Seq$();
    var candyStocks = $as_sc_Seq(updatedValue.map__F1__scg_CanBuildFrom__O(jsx$3, this$3.ReusableCBFInstance$2));
    var jsx$6 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$6$2) {
      var x$6 = $as_T2(x$6$2);
      return $as_sc_Seq(x$6.$$und2$f)
    }));
    var this$4 = $m_sc_Seq$();
    var jsx$5 = $as_sc_TraversableLike(updatedValue.flatMap__F1__scg_CanBuildFrom__O(jsx$6, this$4.ReusableCBFInstance$2));
    var jsx$4 = new $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1$$anonfun$4().init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1(this);
    var this$5 = $m_sc_Seq$();
    var actionResults = $as_sc_Seq(jsx$5.map__F1__scg_CanBuildFrom__O(jsx$4, this$5.ReusableCBFInstance$2));
    var jsx$8 = $as_Ldiode_Effect(actionResults.head__O());
    var jsx$7 = $as_sc_TraversableOnce(actionResults.tail__O()).toSet__sci_Set();
    var e = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
    var effectSet = new $c_Ldiode_EffectSet().init___Ldiode_Effect__sci_Set__s_concurrent_ExecutionContext(jsx$8, jsx$7, $as_s_concurrent_ExecutionContext(e));
    return this.$$outer$2.updated__O__Ldiode_Effect__Ldiode_ActionResult(candyStocks, effectSet)
  } else {
    return $default.apply__O__O(x1)
  }
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$2$$anonfun$handle$1", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$2$$anonfun$handle$1;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3() {
  $c_sr_AbstractPartialFunction.call(this);
  this.$$outer$2 = null
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype.isDefinedAt__O__Z = (function(x3) {
  var x = $m_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$();
  if ((x === x3)) {
    return true
  } else {
    return ($is_Lcom_github_aafa_vending_diode_InsertCoin(x3) || ($is_Lcom_github_aafa_vending_diode_NotEnoughCoins(x3) || ($is_Lcom_github_aafa_vending_diode_NoCandiesLeft(x3) || ($is_Lcom_github_aafa_vending_diode_GetYourCandy(x3) || $is_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(x3)))))
  }
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype.applyOrElse__O__F1__O = (function(x3, $default) {
  var x = $m_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$();
  if ((x === x3)) {
    return this.$$outer$2.updated__O__Ldiode_ActionResult("Merry Christmas and Happy New Year! :)")
  } else if ($is_Lcom_github_aafa_vending_diode_InsertCoin(x3)) {
    return this.$$outer$2.updated__O__Ldiode_ActionResult("What candy do you want?")
  } else if ($is_Lcom_github_aafa_vending_diode_NotEnoughCoins(x3)) {
    var x3$2 = $as_Lcom_github_aafa_vending_diode_NotEnoughCoins(x3);
    var coinsSlot = x3$2.inMachine$1;
    var price = x3$2.price$1;
    return this.$$outer$2.updated__O__Ldiode_ActionResult(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["You don't have enough coins, add ", " more!"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([((price.value$1 - coinsSlot.value$1) | 0)])))
  } else {
    return ($is_Lcom_github_aafa_vending_diode_NoCandiesLeft(x3) ? this.$$outer$2.updated__O__Ldiode_ActionResult("Sorry, no candies left! :(") : ($is_Lcom_github_aafa_vending_diode_GetYourCandy(x3) ? this.$$outer$2.updated__O__Ldiode_ActionResult("Get your candy!") : ($is_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(x3) ? this.$$outer$2.updated__O__Ldiode_ActionResult("Candy slot is full, grab your candy first!") : $default.apply__O__O(x3))))
  }
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype.init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$3 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$3$$anonfun$handle$3", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$3$$anonfun$handle$3;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4() {
  $c_sr_AbstractPartialFunction.call(this);
  this.$$outer$2 = null
}
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype.constructor = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype = $c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype;
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype.init___Lcom_github_aafa_vending_diode_AppCircuit$$anon$4 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype.isDefinedAt__O__Z = (function(x4) {
  return ($is_Lcom_github_aafa_vending_diode_InsertCoin(x4) || $is_Lcom_github_aafa_vending_diode_CoinsSpent(x4))
});
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype.applyOrElse__O__F1__O = (function(x4, $default) {
  if ($is_Lcom_github_aafa_vending_diode_InsertCoin(x4)) {
    var x2 = $as_Lcom_github_aafa_vending_diode_InsertCoin(x4);
    var coin = x2.c$1;
    var jsx$1 = this.$$outer$2;
    var this$1 = this.$$outer$2;
    return jsx$1.updated__O__Ldiode_ActionResult(new $c_Lcom_github_aafa_vending_diode_CandyCoin().init___I((($as_Lcom_github_aafa_vending_diode_CandyCoin(this$1.modelRW$1.eval__O__O(this$1.currentModel$1)).value$1 + coin.value$1) | 0)))
  } else if ($is_Lcom_github_aafa_vending_diode_CoinsSpent(x4)) {
    var x3 = $as_Lcom_github_aafa_vending_diode_CoinsSpent(x4);
    var coin$2 = x3.c$1;
    var jsx$2 = this.$$outer$2;
    var this$2 = this.$$outer$2;
    return jsx$2.updated__O__Ldiode_ActionResult(new $c_Lcom_github_aafa_vending_diode_CandyCoin().init___I((($as_Lcom_github_aafa_vending_diode_CandyCoin(this$2.modelRW$1.eval__O__O(this$2.currentModel$1)).value$1 - coin$2.value$1) | 0)))
  } else {
    return $default.apply__O__O(x4)
  }
});
var $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4 = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4: 0
}, false, "com.github.aafa.vending.diode.AppCircuit$$anon$4$$anonfun$handle$4", {
  Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4.prototype.$classData = $d_Lcom_github_aafa_vending_diode_AppCircuit$$anon$4$$anonfun$handle$4;
/** @constructor */
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$1.prototype.applyOrElse__jl_Throwable__F1__O = (function(x1, $default) {
  if ((x1 !== null)) {
    var this$1 = this.$$outer$2;
    var msg = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Error in processing effects for action ", ": ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.action$5$2, x1]));
    $s_Ldiode_Circuit$class__handleError__Ldiode_Circuit__T__V(this$1, msg);
    return (void 0)
  } else {
    return $default.apply__O__O(x1)
  }
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$1.prototype.init___Ldiode_Circuit__O = (function($$outer, action$5) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.action$5$2 = action$5;
  return this
});
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$2.prototype.applyOrElse__jl_Throwable__F1__O = (function(x2, $default) {
  if ((x2 !== null)) {
    var this$1 = this.$$outer$2;
    var msg = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Error in processing effects for action ", ": ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.action$5$2, x2]));
    $s_Ldiode_Circuit$class__handleError__Ldiode_Circuit__T__V(this$1, msg);
    return (void 0)
  } else {
    return $default.apply__O__O(x2)
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$2.prototype.init___Ldiode_Circuit__O = (function($$outer, action$5) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$3.prototype = new $h_sr_AbstractPartialFunction();
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$3.prototype.isDefinedAt__jl_Throwable__Z = (function(x3) {
  return (x3 !== null)
});
$c_Ldiode_Circuit$$anonfun$dispatchBase$3.prototype.applyOrElse__jl_Throwable__F1__O = (function(x3, $default) {
  if ((x3 !== null)) {
    var this$1 = this.$$outer$2;
    var msg = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Error in processing effects for action ", ": ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.action$5$2, x3]));
    $s_Ldiode_Circuit$class__handleError__Ldiode_Circuit__T__V(this$1, msg);
    return (void 0)
  } else {
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$3.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__jl_Throwable__Z($as_jl_Throwable(x))
});
$c_Ldiode_Circuit$$anonfun$dispatchBase$3.prototype.init___Ldiode_Circuit__O = (function($$outer, action$5) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$3.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__jl_Throwable__F1__O($as_jl_Throwable(x), $default)
});
...
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$() {
  $c_O.call(this)
}
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.constructor = $c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype = $c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype;
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.productPrefix__T = (function() {
  return "CandyTakenFromSlot"
});
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.productArity__I = (function() {
  return 0
});
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.toString__T = (function() {
  return "CandyTakenFromSlot"
});
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.hashCode__I = (function() {
  return 62012010
});
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$ = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_CandyTakenFromSlot$: 0
}, false, "com.github.aafa.vending.diode.CandyTakenFromSlot$", {
  Lcom_github_aafa_vending_diode_CandyTakenFromSlot$: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$.prototype.$classData = $d_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$;
var $n_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$ = (void 0);
function $m_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$() {
  if ((!$n_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$)) {
    $n_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$ = new $c_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$().init___()
  };
  return $n_Lcom_github_aafa_vending_diode_CandyTakenFromSlot$
}
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_CoinsSpent() {
  $c_O.call(this);
  this.c$1 = null
}
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.constructor = $c_Lcom_github_aafa_vending_diode_CoinsSpent;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_CoinsSpent() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_CoinsSpent.prototype = $c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype;
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.productPrefix__T = (function() {
  return "CoinsSpent"
});
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_CoinsSpent(x$1)) {
    var CoinsSpent$1 = $as_Lcom_github_aafa_vending_diode_CoinsSpent(x$1);
    var x = this.c$1;
    var x$2 = CoinsSpent$1.c$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.c$1;
      break
...
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.init___Lcom_github_aafa_vending_diode_CandyCoin = (function(c) {
  this.c$1 = c;
  return this
});
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_CoinsSpent(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_CoinsSpent)))
}
function $as_Lcom_github_aafa_vending_diode_CoinsSpent(obj) {
  return (($is_Lcom_github_aafa_vending_diode_CoinsSpent(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.CoinsSpent"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_CoinsSpent(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_CoinsSpent)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_CoinsSpent(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_CoinsSpent(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.CoinsSpent;", depth))
}
var $d_Lcom_github_aafa_vending_diode_CoinsSpent = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_CoinsSpent: 0
}, false, "com.github.aafa.vending.diode.CoinsSpent", {
  Lcom_github_aafa_vending_diode_CoinsSpent: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_CoinsSpent.prototype.$classData = $d_Lcom_github_aafa_vending_diode_CoinsSpent;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_GetYourCandy() {
  $c_O.call(this);
  this.candy$1 = null
}
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.constructor = $c_Lcom_github_aafa_vending_diode_GetYourCandy;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_GetYourCandy() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_GetYourCandy.prototype = $c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype;
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.init___Lcom_github_aafa_vending_diode_Candy = (function(candy) {
  this.candy$1 = candy;
  return this
});
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.productPrefix__T = (function() {
  return "GetYourCandy"
});
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_GetYourCandy(x$1)) {
    var GetYourCandy$1 = $as_Lcom_github_aafa_vending_diode_GetYourCandy(x$1);
    var x = this.candy$1;
    var x$2 = GetYourCandy$1.candy$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.candy$1;
      break
...
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_GetYourCandy(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_GetYourCandy)))
}
function $as_Lcom_github_aafa_vending_diode_GetYourCandy(obj) {
  return (($is_Lcom_github_aafa_vending_diode_GetYourCandy(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.GetYourCandy"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_GetYourCandy(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_GetYourCandy)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_GetYourCandy(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_GetYourCandy(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.GetYourCandy;", depth))
}
var $d_Lcom_github_aafa_vending_diode_GetYourCandy = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_GetYourCandy: 0
}, false, "com.github.aafa.vending.diode.GetYourCandy", {
  Lcom_github_aafa_vending_diode_GetYourCandy: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_GetYourCandy.prototype.$classData = $d_Lcom_github_aafa_vending_diode_GetYourCandy;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst() {
  $c_O.call(this);
  this.candy$1 = null
}
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.constructor = $c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_GrabYourCandyFirst() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype = $c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype;
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.init___Lcom_github_aafa_vending_diode_Candy = (function(candy) {
  this.candy$1 = candy;
  return this
});
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.productPrefix__T = (function() {
  return "GrabYourCandyFirst"
});
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(x$1)) {
    var GrabYourCandyFirst$1 = $as_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(x$1);
    var x = this.candy$1;
    var x$2 = GrabYourCandyFirst$1.candy$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.candy$1;
      break
...
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_GrabYourCandyFirst)))
}
function $as_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(obj) {
  return (($is_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.GrabYourCandyFirst"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_GrabYourCandyFirst)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_GrabYourCandyFirst(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.GrabYourCandyFirst;", depth))
}
var $d_Lcom_github_aafa_vending_diode_GrabYourCandyFirst = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_GrabYourCandyFirst: 0
}, false, "com.github.aafa.vending.diode.GrabYourCandyFirst", {
  Lcom_github_aafa_vending_diode_GrabYourCandyFirst: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_GrabYourCandyFirst.prototype.$classData = $d_Lcom_github_aafa_vending_diode_GrabYourCandyFirst;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_InsertCoin() {
  $c_O.call(this);
  this.c$1 = null
}
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.constructor = $c_Lcom_github_aafa_vending_diode_InsertCoin;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_InsertCoin() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_InsertCoin.prototype = $c_Lcom_github_aafa_vending_diode_InsertCoin.prototype;
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.productPrefix__T = (function() {
  return "InsertCoin"
});
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_InsertCoin(x$1)) {
    var InsertCoin$1 = $as_Lcom_github_aafa_vending_diode_InsertCoin(x$1);
    var x = this.c$1;
    var x$2 = InsertCoin$1.c$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.c$1;
      break
...
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.init___Lcom_github_aafa_vending_diode_CandyCoin = (function(c) {
  this.c$1 = c;
  return this
});
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_InsertCoin(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_InsertCoin)))
}
function $as_Lcom_github_aafa_vending_diode_InsertCoin(obj) {
  return (($is_Lcom_github_aafa_vending_diode_InsertCoin(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.InsertCoin"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_InsertCoin(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_InsertCoin)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_InsertCoin(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_InsertCoin(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.InsertCoin;", depth))
}
var $d_Lcom_github_aafa_vending_diode_InsertCoin = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_InsertCoin: 0
}, false, "com.github.aafa.vending.diode.InsertCoin", {
  Lcom_github_aafa_vending_diode_InsertCoin: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_InsertCoin.prototype.$classData = $d_Lcom_github_aafa_vending_diode_InsertCoin;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_NoCandiesLeft() {
  $c_O.call(this);
  this.candy$1 = null
}
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.constructor = $c_Lcom_github_aafa_vending_diode_NoCandiesLeft;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_NoCandiesLeft() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype = $c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype;
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.init___Lcom_github_aafa_vending_diode_Candy = (function(candy) {
  this.candy$1 = candy;
  return this
});
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.productPrefix__T = (function() {
  return "NoCandiesLeft"
});
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_NoCandiesLeft(x$1)) {
    var NoCandiesLeft$1 = $as_Lcom_github_aafa_vending_diode_NoCandiesLeft(x$1);
    var x = this.candy$1;
    var x$2 = NoCandiesLeft$1.candy$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.candy$1;
      break
...
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_NoCandiesLeft(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_NoCandiesLeft)))
}
function $as_Lcom_github_aafa_vending_diode_NoCandiesLeft(obj) {
  return (($is_Lcom_github_aafa_vending_diode_NoCandiesLeft(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.NoCandiesLeft"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_NoCandiesLeft(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_NoCandiesLeft)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_NoCandiesLeft(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_NoCandiesLeft(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.NoCandiesLeft;", depth))
}
var $d_Lcom_github_aafa_vending_diode_NoCandiesLeft = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_NoCandiesLeft: 0
}, false, "com.github.aafa.vending.diode.NoCandiesLeft", {
  Lcom_github_aafa_vending_diode_NoCandiesLeft: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_NoCandiesLeft.prototype.$classData = $d_Lcom_github_aafa_vending_diode_NoCandiesLeft;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_NotEnoughCoins() {
  $c_O.call(this);
  this.inMachine$1 = null;
  this.price$1 = null
}
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.constructor = $c_Lcom_github_aafa_vending_diode_NotEnoughCoins;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_NotEnoughCoins() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype = $c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype;
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.productPrefix__T = (function() {
  return "NotEnoughCoins"
});
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.init___Lcom_github_aafa_vending_diode_CandyCoin__Lcom_github_aafa_vending_diode_CandyCoin = (function(inMachine, price) {
  this.inMachine$1 = inMachine;
  this.price$1 = price;
  return this
});
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.productArity__I = (function() {
  return 2
});
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_NotEnoughCoins(x$1)) {
    var NotEnoughCoins$1 = $as_Lcom_github_aafa_vending_diode_NotEnoughCoins(x$1);
    var x = this.inMachine$1;
    var x$2 = NotEnoughCoins$1.inMachine$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.price$1;
      var x$4 = NotEnoughCoins$1.price$1;
      return ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      return false
    }
...
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.inMachine$1;
      break
    }
    case 1: {
      return this.price$1;
...
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_NotEnoughCoins(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_NotEnoughCoins)))
}
function $as_Lcom_github_aafa_vending_diode_NotEnoughCoins(obj) {
  return (($is_Lcom_github_aafa_vending_diode_NotEnoughCoins(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.NotEnoughCoins"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_NotEnoughCoins(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_NotEnoughCoins)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_NotEnoughCoins(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_NotEnoughCoins(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.NotEnoughCoins;", depth))
}
var $d_Lcom_github_aafa_vending_diode_NotEnoughCoins = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_NotEnoughCoins: 0
}, false, "com.github.aafa.vending.diode.NotEnoughCoins", {
  Lcom_github_aafa_vending_diode_NotEnoughCoins: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_NotEnoughCoins.prototype.$classData = $d_Lcom_github_aafa_vending_diode_NotEnoughCoins;
/** @constructor */
function $c_Lcom_github_aafa_vending_diode_PurchaseCandy() {
  $c_O.call(this);
  this.candy$1 = null;
  this.quantity$1 = 0
}
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype = new $h_O();
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.constructor = $c_Lcom_github_aafa_vending_diode_PurchaseCandy;
/** @constructor */
function $h_Lcom_github_aafa_vending_diode_PurchaseCandy() {
  /*<skip>*/
}
$h_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype = $c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype;
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.init___Lcom_github_aafa_vending_diode_Candy__I = (function(candy, quantity) {
  this.candy$1 = candy;
  this.quantity$1 = quantity;
  return this
});
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.productPrefix__T = (function() {
  return "PurchaseCandy"
});
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.productArity__I = (function() {
  return 2
});
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lcom_github_aafa_vending_diode_PurchaseCandy(x$1)) {
    var PurchaseCandy$1 = $as_Lcom_github_aafa_vending_diode_PurchaseCandy(x$1);
    var x = this.candy$1;
    var x$2 = PurchaseCandy$1.candy$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      return (this.quantity$1 === PurchaseCandy$1.quantity$1)
    } else {
      return false
    }
  } else {
...
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.candy$1;
      break
...
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.candy$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.quantity$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lcom_github_aafa_vending_diode_PurchaseCandy(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_github_aafa_vending_diode_PurchaseCandy)))
}
function $as_Lcom_github_aafa_vending_diode_PurchaseCandy(obj) {
  return (($is_Lcom_github_aafa_vending_diode_PurchaseCandy(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.aafa.vending.diode.PurchaseCandy"))
}
function $isArrayOf_Lcom_github_aafa_vending_diode_PurchaseCandy(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_aafa_vending_diode_PurchaseCandy)))
}
function $asArrayOf_Lcom_github_aafa_vending_diode_PurchaseCandy(obj, depth) {
  return (($isArrayOf_Lcom_github_aafa_vending_diode_PurchaseCandy(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.aafa.vending.diode.PurchaseCandy;", depth))
}
var $d_Lcom_github_aafa_vending_diode_PurchaseCandy = new $TypeData().initClass({
  Lcom_github_aafa_vending_diode_PurchaseCandy: 0
}, false, "com.github.aafa.vending.diode.PurchaseCandy", {
  Lcom_github_aafa_vending_diode_PurchaseCandy: 1,
  O: 1,
  Lcom_github_aafa_vending_diode_Action: 1,
  Ldiode_Action: 1,
  s_Product: 1,
...
$c_Lcom_github_aafa_vending_diode_PurchaseCandy.prototype.$classData = $d_Lcom_github_aafa_vending_diode_PurchaseCandy;
/** @constructor */
...
$c_Lscalatags_JsDom$all$.prototype.h2$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (256 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.h2$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "h2", false, ns);
    var b$1 = this.bitmap$0$1;
    var lo$1 = (256 | b$1.lo$2);
    var hi = b$1.hi$2;
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi)
...
$c_scm_ArraySeq.prototype.isDefinedAt__O__Z = (function(x) {
  var idx = $uI(x);
  return $s_sc_GenSeqLike$class__isDefinedAt__sc_GenSeqLike__I__Z(this, idx)
});
...
//# sourceMappingURL=i-want-my-candies-fastopt.js.map
